...
(defn merge-classes [& args] (apply view.config/merge-classes args))
(def badge-variant-classes view.config/badge-variant-classes)
(def badge-size-classes view.config/badge-size-classes)
(def input-size-classes view.config/input-size-classes)
...
(defn form-input [& args] (apply view.form/form-input args))
(defn form-submit-btn [& args] (apply view.form/form-submit-btn args))
(defn form-select [& args] (apply view.form/form-select args))
(defn form-checkbox [& args] (apply view.form/form-checkbox args))
(defn form-radio [& args] (apply view.form/form-radio args))
(defn form-toggle [& args] (apply view.form/form-toggle args))
