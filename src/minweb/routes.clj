(ns minweb.routes
  (:require
   ...
   [minweb.static :as static]
   [minweb.view.examples :as sample]
   [minweb.view.health :as health]
   [minweb.view.index :as index]
...
(def routes
  #(ruuter/route
    [(http-get "/static/:filename*" static/serve-static)
     ...
     (http-post "/delete-it/:type/:id" admin/delete-it)
